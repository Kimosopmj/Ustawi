...
import 'package:ustawi/src/constants/app_sizes.dart';
import 'package:ustawi/src/features/mood_records/data/add_mood_record/mood_configurations.dart';
import 'package:ustawi/src/features/activities/presentation/activity_chips.dart';
import 'package:ustawi/src/features/mood_records/domain/mood_log/mood_record.dart';
import 'package:ustawi/src/features/mood_records/presentation/add_mood_record/add_mood_record_form_controller.dart';
import 'package:ustawi/src/features/mood_records/presentation/add_mood_record/mood_option.dart';
...
class _AddMoodRecordFormState extends ConsumerState<AddMoodRecordForm> {
  ...
  void initState() {
    super.initState();
    _noteController =
        TextEditingController(text: widget.recordToEdit?.value.note);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final tempMoodRecord = ref.watch(
        addMoodRecordFormControllerNotifierProvider(widget.recordToEdit));
      ...
      child: Column(
        children: [
                  ...
                  .map(
                    (config) => GestureDetector(
                      ...
                      child: MoodOption(
                          ...
                          isSelected: tempMoodRecord.score == config.score),
                    ),
                  )
                  .toList(),
            ),
          ...
          OutlinedButton.icon(
            ...
            label: Text(tempMoodRecord.activities.isEmpty
                ? "Add activities".hardcoded
                : "Edit activities".hardcoded),
            icon: Icon(
                tempMoodRecord.activities.isEmpty ? Icons.add : Icons.edit),
          ),
          gapH16,
              ...
              ElevatedButton(
                onPressed: () {
                  controller.saveOrUpdate(
                      widget.recordToEdit?.key, tempMoodRecord);
                  context.pop();
                },
