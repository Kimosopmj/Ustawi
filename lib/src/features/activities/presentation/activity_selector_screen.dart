...
import 'package:ustawi/src/features/activities/data/activity_repository.dart';
import 'package:ustawi/src/features/activities/model/activity.dart';
import 'package:ustawi/src/features/activities/presentation/activity_group.dart';
...
class ActivitySelectorScreen extends ConsumerStatefulWidget {
  const ActivitySelectorScreen(
      {super.key,
      required this.recordActivities,
      required this.updateActivitiesCallback});
  // final MoodRecord =
  final Function updateActivitiesCallback;
  final List<Activity> recordActivities;

  @override
  ConsumerState<ActivitySelectorScreen> createState() =>
      _ActivitySelectorScreenState();
}

class _ActivitySelectorScreenState
    extends ConsumerState<ActivitySelectorScreen> {
