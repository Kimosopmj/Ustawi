...
import 'package:ustawi/src/features/analytics/presentation/chart_frame_card.dart';
...
class ChartFrameController
    extends AutoDisposeFamilyNotifier<List<MoodRecord>, ChartFilter> {
...
final chartFrameControllerProvider = NotifierProvider.family
    .autoDispose<ChartFrameController, List<MoodRecord>, ChartFilter>(
        ChartFrameController.new);
