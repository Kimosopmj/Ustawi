...
class ScaffoldWithBottomNavigationBar extends StatefulWidget {
  const ScaffoldWithBottomNavigationBar(
      {super.key, required this.child, required this.destinations});
  final Widget child;
...
class _ScaffoldWithBottomNavigationBarState
  ...
  int _locationToTabIndex(String location) {
    final index = widget.destinations.indexWhere((t) =>
        location.startsWith(GoRouter.of(context).namedLocation(t.route.name)));
